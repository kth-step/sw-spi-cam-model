...
interrupt: bool; (* interrupts in SPI *)
...
(* tx_environment: externel environment affects the tx state *)
val _ = Datatype `tx_environment = <| assert_interrupt : bool |>`

(* rx_environment: externel environment affects the rx state *)
val _ = Datatype `rx_environment = <| received_data : word8 list;
...
scheduler : schedule;
read_reg : word32;
(* write_reg_env : write_reg_environment; *)
tx_env: tx_environment;
rx_env: rx_environment |>`

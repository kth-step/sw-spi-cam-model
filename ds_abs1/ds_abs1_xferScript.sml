...
TX_SHIFT_REG := (EL (ds_abs1.ds_abs1_xfer.xfer_cur_length - 1) (ds_abs1.ds_abs1_xfer.xfer_dataOUT_buffer))|>`
...
case ds_abs1.ds_abs1_xfer.state of 
  | abs1_xfer_not_ready => ds_abs1 with err := T
  | abs1_xfer_pre => ds_abs1 with err := T
  | abs1_xfer_idle => spi_abs1_xfer_idle_op ds_abs1
  | abs1_xfer_prepare => ds_abs1 with err := T
  | abs1_xfer_trans => ds_abs1 with err := T
  | abs1_xfer_data => spi_abs1_xfer_data_op ds_abs1
...
<| state := if ds_abs1.ds_abs1_xfer.xfer_cur_length < (LENGTH (ds_abs1.ds_abs1_xfer.xfer_dataOUT_buffer)) 
   then abs1_xfer_next else abs1_xfer_ready_for_reset;
...
case ds_abs1.ds_abs1_xfer.state of
  | abs1_xfer_not_ready => ds_abs1 with err := T
  | abs1_xfer_pre => ds_abs1 with err := T
  | abs1_xfer_idle => ds_abs1 with err := T
  | abs1_xfer_prepare => driver_abs1_xfer_prepare_op ds_abs1
  | abs1_xfer_trans => ds_abs1 with err := T
  | abs1_xfer_data => ds_abs1 with err := T
  | abs1_xfer_exchange => ds_abs1 with err := T
  | abs1_xfer_update => ds_abs1 with err := T
...
if ds_abs1.ds_abs1_xfer.state = abs1_xfer_trans 
then (comb_abs1_xfer_trans_op ds_abs1)
else if ds_abs1.ds_abs1_xfer.state = abs1_xfer_ready_for_reset

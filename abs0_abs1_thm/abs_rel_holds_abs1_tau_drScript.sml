...
open ds_abs0_relTheory abs_relTheory ds_abs0_initTheory ds_abs0_txTheory ds_abs0_rxTheory ds_abs0_xferTheory ds_abs0_tauTheory;
...
rw [ds_abs0_tr_cases, ABS0_TAU_LBL_ENABLE_def, abs0_tau_op_def, abs0_rx_update_op_def] >>
...
rw [ds_abs0_tr_cases, ABS0_TAU_LBL_ENABLE_def, abs0_tau_op_def, abs0_rx_reading_op_def] >>
fs [abs_rel_def, IS_ABS_STATE_REL_def],
(* abs1_rx_next *)
`ds_abs0.state = abs0_rx_next` by METIS_TAC [IS_ABS_STATE_REL_def] >>
rw [driver_abs1_rx_next_op_def] >>
rw [ds_abs0_tr_cases, ABS0_TAU_LBL_ENABLE_def, abs0_tau_op_def, abs0_rx_next_op_def] >>
fs [abs_rel_def, IS_ABS_STATE_REL_def],
(* abs1_rx_next_ready *)
`ds_abs0.state = abs0_rx_next` by METIS_TAC [IS_ABS_STATE_REL_def] >>

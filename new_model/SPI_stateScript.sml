...
(* 1st part: spi_state, the SPI controller only contains registers and an error flag *)
...
(* 2nd part: spi_driver, including 4 automatons, init, tx, rx and xfer *)
...
(* spi_driver transmit and receive, full-dulplex *)
...
(* spi_driver: spi driver state, including init, tx, rx and xfer states *)

...
open SPI_stateTheory SPI_relationTheory weak_bisimulationTheory;
open driver_stateTheory driver_relationTheory;
open ds_abs1_stateTheory ref_relTheory ds_abs1_relTheory;
open ref_rel_holds_call_lblTheory ref_rel_holds_trans_lblTheory;
open comb_abs1_hold_ref_rel_spi_trTheory comb_abs1_hold_ref_rel_dr_trTheory comb_abs1_hold_ref_rel_RD_RETheory comb_abs1_hold_ref_rel_WR_UPTheory;
open abs1_comb_hold_ref_rel_tau_spiTheory abs1_comb_hold_ref_rel_tau_drTheory abs1_comb_hold_ref_rel_tau_combTheory;

val _ = new_theory "abs1_comb_weak_bisimulation";

(* weak simulation if (dr,spi) -> (dr', spi') *)
...
(* weak simulation if ds_abs1 -> ds_abs1' *)
...
(* ref_rel is the weak bisimulation relation for ds_abs1 and (dr,spi) 

...
<|TRM := 2w; FORCE := 1w |> |>` by rw [write_SPI_regs_def, dr_write_address_def, 
dr_write_value_def, dr_write_def, dr_write_ch0conf_tx_def, write_CH0CONF_comb_def, 
...
EXISTS_TAC ``dr with state := dr_tx_read_txs`` >>
EXISTS_TAC ``spi_tau_operations 
...
regs := spi.regs with CH0CONF := spi.regs.CH0CONF with
<|TRM := 1w; FORCE := 1w |> |>` by rw [write_SPI_regs_def, dr_write_address_def, 
dr_write_value_def, dr_write_def, dr_write_ch0conf_rx_def, write_CH0CONF_comb_def, 
write_CH0CONF_rx_def, SPI0_CH0CTRL_def, SPI0_PA_RANGE_def, SPI0_END_def, SPI0_START_def,
SPI0_SYSCONFIG_def, SPI0_MODULCTRL_def, SPI0_CH0CONF_def] >>
fs [dr_write_ch0ctrl_def] >>
EXISTS_TAC ``dr with state := dr_rx_read_rxs`` >>
EXISTS_TAC ``spi_tau_operations 
...
Q.EXISTS_TAC `spi_tau_operations (write_SPI_regs (THE (dr_write_address dr)) (THE (dr_write_value dr)) spi)` >>
rw [] >|
[DISJ2_TAC >>
DISJ1_TAC >>
NTAC 6 DISJ2_TAC >>
...
regs := spi.regs with CH0CONF := spi.regs.CH0CONF with
<|TRM := 0w; FORCE := 1w |> |>` by rw [write_SPI_regs_def, dr_write_address_def, 
dr_write_value_def, dr_write_def, dr_write_ch0conf_xfer_def, write_CH0CONF_comb_def, 

...
val _ = new_theory "abs1_comb_hold_ref_rel_dr_tr";
...
[(* not the last byte*)
`ds_abs1.ds_abs1_xfer.xfer_cur_length < (LENGTH (ds_abs1.ds_abs1_xfer.xfer_dataOUT_buffer))` by METIS_TAC [ref_rel_def] >>
...
rw [driver_tr_cases] >>
FULL_SIMP_TAC (std_ss++WORD_ss) [DR_TAU_ENABLE_def, dr_check_def] >>
rw [] >>
